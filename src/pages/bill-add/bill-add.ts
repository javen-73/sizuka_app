...
export class BillAdd {
  ...
  save() {
    ...
    let param = {userId:curr_user.id,bookId:defalut_book.id,money:this.money*100,type:this.selected_default[0].id,priceType:this.priceType,date:this.add_date,remark:this.remark}
